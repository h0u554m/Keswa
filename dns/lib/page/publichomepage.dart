import 'dart:convert';
import 'dart:io';
import 'package:dns/models/RefPriceConfigCategory.dart';
...
class Publichomepage extends StatefulWidget {
  ...
  Publichomepage({this.img, this.np, this.nw});
...
class _PublichomepageState extends State<Publichomepage>
  ...
  TextEditingController hello1 = TextEditingController(text: "80");

  RefPriceConfigCategory info;
  AnimationController animationController;
  function() async {
    http.Response response = await http.get(
      'http://kaftech.org/keswa-api/ref/getAllRefData/RefPriceConfigCategory',
    );
    print(response);
    info = RefPriceConfigCategory.fromJson(response.body);
    if (mounted) {
      setState(() {});
    }
  }
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        buildFlatButton(context, Icons.account_circle, "Login",
                            () {
                ...
                children: <Widget>[
                  ...
                  ti == null
                      ...
                      : _isLoading == true
                          ...
                          : product == null || product.responseCode != "200"
                              ? Center(
                                  child: SingleChildScrollView(
                                  child: Container(
                                    child: Column(
                                                                ...
                                                                child: Center(
                                                                  child: new GridView
                                                                      ...
                                                                      gridDelegate:
                                                                        ...
                                                                        crossAxisCount: product.responseData.sizesStr.length >=
                                                                                8
                                                                            ? 3
                                                                            : 2,
                                                                        childAspectRatio:
